        ...
        if ( responseData instanceof LookupUserResponseData ) {
            ...
            if ( lookupUserResponse.getLoanedItems() != null && lookupUserResponse.getLoanedItems().size() > 0 ) {
                ...
                for ( LoanedItem loanedItem : lookupUserResponse.getLoanedItems() ) {
                    ...
                    System.out.println("Loaned item amount: " + ServiceHelper.formatMonetaryAmount(
                    ...
                    System.out.println("Loaned item medium type: " + ServiceHelper.formatSVP(loanedItem.getMediumType()));
            ...
            if ( lookupUserResponse.getLoanedItemsCounts() != null && lookupUserResponse.getLoanedItemsCounts().size() > 0 ) {
                ...
                for ( LoanedItemsCount loanedItemsCount : lookupUserResponse.getLoanedItemsCounts() ) {
                    ...
                    System.out.println("Loaned item count circ status: " + ServiceHelper.formatSVP(loanedItemsCount.getCirculationStatus()));
                    System.out.println("Loaned item count use restriction: " + ServiceHelper.formatSVP(loanedItemsCount.getItemUseRestrictionType()));
            ...
            if ( lookupUserResponse.getRequestedItems() != null && lookupUserResponse.getRequestedItems().size() > 0 ) {
                ...
                for ( RequestedItem requestedItem : lookupUserResponse.getRequestedItems() ) {
                    ...
                    System.out.println("Request status type: " + ServiceHelper.formatSVP(requestedItem.getRequestStatusType()));
                    System.out.println("Request type: " + ServiceHelper.formatSVP(requestedItem.getRequestType()));
                    System.out.println("Requested item title: " + requestedItem.getTitle());
                    System.out.println("Requested item medium type: " + ServiceHelper.formatSVP(requestedItem.getMediumType()));
                    ...
                    System.out.println("Pickup location: " + ServiceHelper.formatSVP(requestedItem.getPickupLocation()));
            ...
            if ( lookupUserResponse.getRequestedItemsCounts() != null && lookupUserResponse.getRequestedItemsCounts().size() > 0 ) {
                ...
                for ( RequestedItemsCount requestedItemsCount : lookupUserResponse.getRequestedItemsCounts() ) {
                    ...
                    System.out.println("Requested item count circ status: " + ServiceHelper.formatSVP(requestedItemsCount.getCirculationStatus()));
                    System.out.println("Requested item count use restriction: " + ServiceHelper.formatSVP(requestedItemsCount.getItemUseRestrictionType()));
                    System.out.println("Requested item count request type: " + ServiceHelper.formatSVP(requestedItemsCount.getRequestType()));
