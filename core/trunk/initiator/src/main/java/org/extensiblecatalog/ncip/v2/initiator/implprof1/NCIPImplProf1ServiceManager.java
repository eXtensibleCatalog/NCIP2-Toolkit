...
public class NCIPImplProf1ServiceManager implements InitiatorServiceManager {
    ...
    private static final Logger LOG = Logger.getLogger(NCIPImplProf1ServiceManager.class);

    protected NCIPClient ncipClient;
    ...
    public NCIPImplProf1ServiceManager() {
        // Do nothing - assume dependencies will be injected
    }

    public NCIPImplProf1ServiceManager(Properties properties) {

        // TODO: Create standard-style property keys for this
    ...
    public void setNCIPClient(NCIPClient ncipClient) {
        this.ncipClient = ncipClient;
    }

    public NCIPClient getNCIPClient() {
        return ncipClient;
    }
     ...
     */
    @Override
    public synchronized InputStream sendMessage(byte[] initiationMsgBytes) throws ServiceException {
