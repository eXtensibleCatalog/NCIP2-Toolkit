...
public class NCIPImplProf1Client implements NCIPClient {
    ...
    public NCIPImplProf1Client(String targetAddress) throws ToolkitException {
        this(targetAddress, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT, StatisticsBeanFactory.buildStatisticsBean());
    }
    ...
    public NCIPImplProf1Client() throws ToolkitException {
        this(null, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT, StatisticsBeanFactory.buildStatisticsBean());
    }
