...
public interface StatisticsBeanConfiguration extends ToolkitConfiguration {
    ...
    final String STATISTICS_BEAN_PROPERTIES_FILE_TITLE_KEY = "StatisticsBeanConfiguration.PropertiesFileTitle";
    final String STATISTICS_BEAN_PROPERTIES_FILE_TITLE_DEFAULT = null;

    final String STATISTICS_BEAN_LOCAL_PROPERTIES_FILE_TITLE_KEY = "StatisticsBeanConfiguration.LocalPropertiesFileTitle";
    final String STATISTICS_BEAN_LOCAL_PROPERTIES_FILE_TITLE_DEFAULT = null;
    ...
    final String STATISTICS_BEAN_LOCAL_PROPERTIES_FILENAME_DEFAULT = "${ToolkitConfiguration.AppName}statisticsbean.properties";

    final String STATISTICS_BEAN_CONFIG_PROPERTIES_FILE_OVERRIDE_KEY = "StatisticsBeanConfiguration.PropertiesFileOverride";
    final String STATISTICS_BEAN_CONFIG_PROPERTIES_FILE_OVERRIDE_DEFAULT = null;
    ...
    // "resources\statisticsbeanconfig.xml".
