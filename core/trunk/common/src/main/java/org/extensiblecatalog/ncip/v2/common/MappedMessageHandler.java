...
public class MappedMessageHandler implements MessageHandler {
    ...
    /**
     * Create an instance of the message handler without initializing properties; this is intended
    ...
    /**
     * Construct a new MappedMessageHandler using the provided {@link Properties} object.
     * @param properties properties that should override those loaded from the environment (e.g. Spring
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            throw new ToolkitException("Exception constructing " + className + " using Properties:", e);
    ...
    /**
     * Deprecated: Use {@link MappedMessageHandler(Properties)} or {@link MappedMessageHandler(CoreConfiguration)}.
...
//---
            ...
            List<Problem> problems = ServiceHelper.generateProblems(
                    Version1GeneralProcessingError.TEMPORARY_PROCESSING_FAILURE, null, null, "Translation of initiation message failed (initiationData is null)");
            ProblemResponseData problemResponseData = new ProblemResponseData();
            problemResponseData.setProblems(problems);
            responseData = problemResponseData;
