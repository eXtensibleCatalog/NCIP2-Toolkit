...
public class BibliographicDescription {
    ...
    public BibliographicItemId getBibliographicItemId(int index) {
        return bibliographicItemIds.get(index);
    }
    ...
    public BibliographicRecordId getBibliographicRecordId(int index) {
        return bibliographicRecordIds.get(index);
    }
    ...
    public void setCitationSource(CitationSource citationSource) {
