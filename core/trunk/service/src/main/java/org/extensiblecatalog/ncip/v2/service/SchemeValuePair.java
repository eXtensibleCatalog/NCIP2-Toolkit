...
public abstract class SchemeValuePair {
    ...
    protected static final Map<String /* Class name including pkg */, SchemeValueBehavior> BEHAVIOR_BY_CLASS_NAME_MAP
            = new HashMap<String, SchemeValueBehavior>();
    ...
    static <SVP extends SchemeValuePair> SVP addIfAbsent(final String scheme, final String value,
                                                         final List<SVP> values, Class<SVP> svpClass)
            throws ServiceException {
