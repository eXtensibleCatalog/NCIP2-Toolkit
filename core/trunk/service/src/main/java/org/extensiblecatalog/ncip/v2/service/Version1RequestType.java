...
public class Version1RequestType extends RequestType {
    ...
    public static final Version1RequestType NON_RETURNABLE_COPY = new Version1RequestType(VERSION_1_REQUEST_TYPE,
            "Non-returnable Copy");
    // Request is for the retrieval of the Item from a location that may not be accessible to a User.
    public static final Version1RequestType STACK_RETRIEVAL = new Version1RequestType(VERSION_1_REQUEST_TYPE,
            "Stack Retrieval");
