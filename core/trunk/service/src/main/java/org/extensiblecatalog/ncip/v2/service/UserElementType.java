...
public class UserElementType extends SchemeValuePair {
    ...
    private static final Logger LOG = Logger.getLogger(UserElementType.class);

    private static final List<UserElementType> VALUES_LIST = new CopyOnWriteArrayList<UserElementType>();
    ...
    /**
     * Find the UserElementType that matches the scheme & value strings supplied.
     *
     * @param scheme a String representing the Scheme URI.
     * @param value  a String representing the Value in the Scheme.
     * @return an UserElementType that matches, or null if none is found to match.
     */
