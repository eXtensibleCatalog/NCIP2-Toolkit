...
/**
 * Identifies the type of LocationType.
 */
public class LocationType extends SchemeValuePair {

    private static final Logger LOG = Logger.getLogger(LocationType.class);

    private static final List<LocationType> VALUES_LIST = new CopyOnWriteArrayList<LocationType>();
    ...
    /**
     * Find the LocationType that matches the scheme & value strings supplied.
     *
     * @param scheme a String representing the Scheme URI.
     * @param value  a String representing the Value in the Scheme.
     * @return an LocationType that matches, or null if none is found to match.
     */
