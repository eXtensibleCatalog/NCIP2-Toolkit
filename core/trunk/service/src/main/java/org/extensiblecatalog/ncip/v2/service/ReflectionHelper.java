...
public final class ReflectionHelper {
    ...
    /**
     * Iterate over the fields, find the first {@Link NCIPData} field with a getter with a non-null result
     * and return it.
     *
     * @param ncipMessage
     * @return
     */
    public static NCIPData unwrapFirstNonNullNCIPDataFieldViaGetter(NCIPMessage ncipMessage)
