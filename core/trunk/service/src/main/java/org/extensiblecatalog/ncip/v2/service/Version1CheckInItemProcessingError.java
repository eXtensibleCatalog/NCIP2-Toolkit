...
public class Version1CheckInItemProcessingError extends ProblemType {
    ...
    public static final Version1CheckInItemProcessingError ITEM_NOT_CHECKED_OUT
            = new Version1CheckInItemProcessingError(VERSION_1_CHECK_IN_ITEM_PROCESSING_ERROR, "Item Not Checked Out"); // There is no record of the check out of the Item.

    public static final Version1CheckInItemProcessingError UNKNOWN_ITEM
            = new Version1CheckInItemProcessingError(VERSION_1_CHECK_IN_ITEM_PROCESSING_ERROR, "Unknown Item"); // Item is not known.
