...
/**
 * Identifies the type of ElectronicAddressType.
 */
public class ElectronicAddressType extends SchemeValuePair {

    private static final Logger LOG = Logger.getLogger(ElectronicAddressType.class);

    private static final List<ElectronicAddressType> VALUES_LIST = new CopyOnWriteArrayList<ElectronicAddressType>();
