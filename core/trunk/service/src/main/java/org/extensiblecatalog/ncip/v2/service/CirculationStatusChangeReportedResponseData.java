...
/**
 * Carries data elements describing the CirculationStatusChangeReportedResponse.
 */
public class CirculationStatusChangeReportedResponseData implements NCIPResponseData {
