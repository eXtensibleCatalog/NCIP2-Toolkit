...
public class AuthenticationInputTypeJAXBElementSchemeValuePairConverter
    extends BaseJAXBElementSchemeValuePairConverter<SchemeValuePair,
            AuthenticationInputType> {

    public AuthenticationInputTypeJAXBElementSchemeValuePairConverter() {
        super(org.extensiblecatalog.ncip.v2.binding.ncipv2_01.jaxb.elements.SchemeValuePair.class, AuthenticationInputType.class);
    }
