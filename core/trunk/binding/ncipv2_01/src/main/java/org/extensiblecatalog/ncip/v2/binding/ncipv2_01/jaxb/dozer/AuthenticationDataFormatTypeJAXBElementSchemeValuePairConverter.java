...
public class AuthenticationDataFormatTypeJAXBElementSchemeValuePairConverter
    extends BaseJAXBElementSchemeValuePairConverter<SchemeValuePair,
            AuthenticationDataFormatType> {

    public AuthenticationDataFormatTypeJAXBElementSchemeValuePairConverter() {
        super(org.extensiblecatalog.ncip.v2.binding.ncipv2_01.jaxb.elements.SchemeValuePair.class, AuthenticationDataFormatType.class);
    }
