...
public class CurrencyCodeSchemeValuePairConverter
    extends BaseSchemeValuePairConverter<SchemeValuePair,
            CurrencyCode> {

    public CurrencyCodeSchemeValuePairConverter() {
        super(org.extensiblecatalog.ncip.v2.binding.ncipv2_01.jaxb.elements.SchemeValuePair.class, CurrencyCode.class);
    }
