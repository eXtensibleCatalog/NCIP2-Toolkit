...
import org.extensiblecatalog.ncip.v2.binding.ncipv2_01.jaxb.elements.*;
...
public class NCIPv2_01ContentMappingFactory extends BaseContentConverter<
        SchemeValuePair, Ext> {
    ...
    public NCIPv2_01ContentMappingFactory() {

        super(org.extensiblecatalog.ncip.v2.binding.ncipv2_01.jaxb.elements.SchemeValuePair.class, Ext.class);

    }

    @Override
    // TODO: Couldn't createExtension & getObjectFactory be moved to JAXBHelper and this class eliminated?
