...
import org.extensiblecatalog.ncip.v2.binding.ilsdiv1_0.jaxb.elements.NCIPMessage;
import org.extensiblecatalog.ncip.v2.common.TranslatorConfiguration;
import org.extensiblecatalog.ncip.v2.service.ToolkitException;

public class ILSDIv1_0JAXBDozerTranslator extends BaseJAXBDozerTranslator<NCIPMessage> {

    /**
     * Default constructor, uses default configuration.
     */
    public ILSDIv1_0JAXBDozerTranslator() throws ToolkitException {
     ...
     */
    public ILSDIv1_0JAXBDozerTranslator(TranslatorConfiguration config) throws ToolkitException {
