 ...
 *         &lt;element ref="{http://www.niso.org/2008/ncip}DesiredDateForReturn" minOccurs="0"/>
...
public class RenewItem {
    ...
    @XmlElement(name = "DesiredDateForReturn", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar desiredDateForReturn;
     ...
     *     
     */
    public XMLGregorianCalendar getDesiredDateForReturn() {
     ...
     *     
     */
    public void setDesiredDateForReturn(XMLGregorianCalendar value) {
