 ...
 *           &lt;sequence>
 *             &lt;element ref="{http://www.niso.org/2008/ncip}BibInformation" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "LookupItemSetResponse")
public class LookupItemSetResponse {

    @XmlElement(name = "ResponseHeader")
    protected ResponseHeader responseHeader;
    @XmlElement(name = "Problem")
    protected List<Problem> problem;
    @XmlElement(name = "BibInformation")
    protected List<BibInformation> bibInformation;
    ...
    /**
     * Gets the value of the bibInformation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bibInformation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBibInformation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BibInformation> getBibInformation() {
        if (bibInformation == null) {
            bibInformation = new ArrayList<BibInformation>();
        }
        return this.bibInformation;
    }
