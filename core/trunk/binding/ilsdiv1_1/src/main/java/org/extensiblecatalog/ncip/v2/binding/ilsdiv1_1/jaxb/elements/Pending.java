 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.niso.org/2008/ncip}DateOfExpectedReply" minOccurs="0"/>
...
public class Pending {
    ...
    @XmlElement(name = "DateOfExpectedReply", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dateOfExpectedReply;
    @XmlElement(name = "Ext")
    protected Ext ext;
     ...
     *     
     */
    public XMLGregorianCalendar getDateOfExpectedReply() {
     ...
     *     
     */
    public void setDateOfExpectedReply(XMLGregorianCalendar value) {
