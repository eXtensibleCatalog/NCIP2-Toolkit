 ...
 */
public final class SimpleCancelRequestItemClient extends SimpleClient {

    public SimpleCancelRequestItemClient() {
    }
    ...
    public static void main(String[] args) throws ServiceException, ValidationException, ToolkitException,
        ...
        SimpleCancelRequestItemClient client = new SimpleCancelRequestItemClient();
    ...
    public void doService(String targetURL, String[] params) throws ServiceException, ValidationException,
        ...
        CancelRequestItemInitiationData cancelRequestItemData = new CancelRequestItemInitiationData();
        ...
        NCIPResponseData responseData = service.performService(cancelRequestItemData, serviceContext, serviceManager);

        if (responseData instanceof CancelRequestItemResponseData) {

            CancelRequestItemResponseData cancelRequestItemResponseData = (CancelRequestItemResponseData)responseData;

            if (cancelRequestItemResponseData.getProblems() != null
                && cancelRequestItemResponseData.getProblems().size() > 0) {
                StringBuilder problemBuffer = new StringBuilder();
                for (Problem problem : cancelRequestItemResponseData.getProblems()) {
                ...
                System.out.println("Cancel Request Item succeeded: " + cancelRequestItemResponseData);
                System.out.println("The request id is: "
                    + cancelRequestItemResponseData.getRequestId().getRequestIdentifierValue());
            }
