...
public class StatisticsReportServlet extends HttpServlet {
    ...
    /**
     * The {@link ToolkitStatisticsBean} instance used to report performance data.
     */
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for ( Map.Entry<String, ToolkitStatisticsBean.StatsRecord> statRecord : statisticsBean.getStatsRecords().entrySet() ) {
