...
public final class ReflectionHelper {
    ...
    // TODO: Can't this and parameterTypesToString be merged?
    /**
     * Format class names
     * @param classes
     * @return
    ...
    /**
     * Iterate over the fields, find the first field with a getter that is non-null
     * and return it.
     *
     * @param wrapper
     * @return
     */
    public static Object unwrapFirstNonNullFieldViaGetter(Object wrapper)
        ...
        if ( wrapper != null ) {
            ...
            for ( Field f : fields ) {
                ...
                if ( m != null ) {
                    ...
                    result = m.invoke(wrapper);
                    if ( result != null ) {

                        if ( isCollection(result.getClass() ) ) {
