...
public class ToolkitStatisticsBean {

    private static final Logger LOG = Logger.getLogger(ToolkitStatisticsBean.class);
        ...
        if ( labels == null || labels.length == 0 ) {
            ...
            for ( int i = 0; i < stopIndex; i++ ) {
                ...
                if ( label != null && label.getClass().isArray() ) {
                    ...
                    sb.append(createKey((Object[])label));
    ...
    public String createCSVReport() {
        ...
        // Body of report
        for ( Map.Entry<String, ToolkitStatisticsBean.StatsRecord> statRecord : getStatsRecords().entrySet() ) {
