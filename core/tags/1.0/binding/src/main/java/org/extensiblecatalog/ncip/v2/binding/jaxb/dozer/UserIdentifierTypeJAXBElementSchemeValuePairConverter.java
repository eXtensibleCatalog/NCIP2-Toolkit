...
public class UserIdentifierTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<UserIdentifierType> {

    public UserIdentifierTypeJAXBElementSchemeValuePairConverter() {
        super(UserIdentifierType.class);
    }
