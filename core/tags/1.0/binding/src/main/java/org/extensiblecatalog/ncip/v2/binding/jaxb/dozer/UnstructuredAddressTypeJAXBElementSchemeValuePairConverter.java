...
public class UnstructuredAddressTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<UnstructuredAddressType> {

    public UnstructuredAddressTypeJAXBElementSchemeValuePairConverter() {
        super(UnstructuredAddressType.class);
    }
