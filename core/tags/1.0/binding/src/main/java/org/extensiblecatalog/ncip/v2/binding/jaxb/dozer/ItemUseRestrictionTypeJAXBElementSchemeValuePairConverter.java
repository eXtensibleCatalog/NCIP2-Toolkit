...
public class ItemUseRestrictionTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<ItemUseRestrictionType> {

    public ItemUseRestrictionTypeJAXBElementSchemeValuePairConverter() {
        super(ItemUseRestrictionType.class);
    }
