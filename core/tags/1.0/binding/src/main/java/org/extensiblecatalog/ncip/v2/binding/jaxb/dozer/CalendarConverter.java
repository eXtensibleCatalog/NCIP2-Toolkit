...
public class CalendarConverter extends DozerConverter<JAXBElement, GregorianCalendar> {
    ...
    @Override
    public GregorianCalendar convertTo(JAXBElement srcObj, GregorianCalendar targetBoolean) {
    ...
    @Override
    public JAXBElement convertFrom(GregorianCalendar srcBoolean, JAXBElement targetObj) {

        JAXBElement result = null;

        MappingUtils.throwMappingException(
            "CalendarConverter.convertFrom() method entered - this should never be called.");
