...
public class TestLookupUser {
    ...
    protected static final String APP_CONFIG_FILENAME = "src/main/resources/dummyconfig.xml";
    ...
    @Test
    public void TestSimpleLookupUser() throws ServiceException {
        ...
        NCIPResponseData responseData = lookupUserService.performService(
            lookupUserData, new DummyRemoteServiceManager());
