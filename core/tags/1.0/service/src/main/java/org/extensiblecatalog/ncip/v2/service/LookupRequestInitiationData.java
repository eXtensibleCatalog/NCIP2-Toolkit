...
/**
 * Carries data elements describing the LookupRequest.
 */
public class LookupRequestInitiationData implements NCIPInitiationData {
     ...
     * RequestElementTypes
     */
    protected List<org.extensiblecatalog.ncip.v2.service.RequestElementType> requestElementTypes;

    /**
     * Set RequestElementTypes.
     */
    public void setRequestElementTypes(
        List<org.extensiblecatalog.ncip.v2.service.RequestElementType> requestElementTypes) {

        this.requestElementTypes = requestElementTypes;

    }

    /**
     * Get RequestElementTypes.
     */
    public List<org.extensiblecatalog.ncip.v2.service.RequestElementType> getRequestElementTypes() {
