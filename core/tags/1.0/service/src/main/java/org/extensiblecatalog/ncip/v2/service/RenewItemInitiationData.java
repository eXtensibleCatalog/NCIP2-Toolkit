...
/**
 * Carries data elements describing the RenewItem.
 */
public class RenewItemInitiationData implements NCIPInitiationData {
     ...
     */
    protected GregorianCalendar desiredDateForReturn;

    /**
     * Set DesiredDateForReturn.
     */
    public void setDesiredDateForReturn(GregorianCalendar desiredDateForReturn) {

        this.desiredDateForReturn = desiredDateForReturn;

    }

    /**
     * Get DesiredDateForReturn.
     */
    public GregorianCalendar getDesiredDateForReturn() {
     ...
     */
    protected List<org.extensiblecatalog.ncip.v2.service.ItemUseRestrictionType> acknowledgedItemUseRestrictionTypes;

    /**
     * Set AcknowledgedItemUseRestrictionTypes.
     */
    public void setAcknowledgedItemUseRestrictionTypes(
        List<org.extensiblecatalog.ncip.v2.service.ItemUseRestrictionType> acknowledgedItemUseRestrictionTypes) {
    ...
    /**
     * Get AcknowledgedItemUseRestrictionTypes.
     */
    public List<org.extensiblecatalog.ncip.v2.service.ItemUseRestrictionType> getAcknowledgedItemUseRestrictionTypes() {
