...
public class NCIPImplProf1Client implements NCIPClient {
    ...
    /**
     * Construct a new NCIPImplProf1Client for the provided target address and {@link org.extensiblecatalog.ncip.v2.common.StatisticsBean},
     * with default timeout values.
     *
     * @param targetAddress the network address of the target NCIP responder
     */
    public NCIPImplProf1Client(String targetAddress, StatisticsBean statisticsBean) {
        this(targetAddress, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT, statisticsBean);
    }

    /**
     * Construct a new NCIPImplProf1Client for the provided target address, with default timeout values and
     * {@link org.extensiblecatalog.ncip.v2.common.StatisticsBean}.
     *
     * @param targetAddress the network address of the target NCIP responder
     */
    public NCIPImplProf1Client(String targetAddress) throws ToolkitException {
        this(targetAddress, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT, StatisticsBeanFactory.getSharedStatisticsBean());
    }

    /**
     * Construct a new NCIPImplProf1Client with no target address (that must be set before calling {@link #sendMessage}
     * and default timeout values and {@link org.extensiblecatalog.ncip.v2.common.StatisticsBean}.
     */
    public NCIPImplProf1Client() throws ToolkitException {
        this(null, DEFAULT_CONNECT_TIMEOUT, DEFAULT_READ_TIMEOUT, StatisticsBeanFactory.getSharedStatisticsBean());
    }
     ...
     */
    public NCIPImplProf1Client(String targetAddress, int connectTimeout, int readTimeout, StatisticsBean statisticsBean) {
    ...
    public InputStream sendMessage(byte[] initiationMsgBytes) throws ServiceException {
        ...
        try {
            ...
            statisticsBean.record(initPerfSvcStartTime, initPerfSvcEndTime,
                StatisticsBean.RESPONDER_PERFORM_SERVICE_LABELS, "External Service at " + targetAddress);
