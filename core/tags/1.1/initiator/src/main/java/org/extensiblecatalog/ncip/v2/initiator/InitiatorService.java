...
public class InitiatorService implements NCIPService<NCIPInitiationData, NCIPResponseData> {
    ...
    protected ServiceValidatorFactory serviceContextFactory;
    ...
    public InitiatorService() throws ToolkitException {
        ...
        this.translator = TranslatorFactory.getTranslator(TranslatorConfigurationFactory.getConfiguration());
        this.serviceContextFactory = new ServiceValidatorFactory();
    ...
    public InitiatorService(CoreConfiguration config) throws ToolkitException {
        ...
        this.serviceContextFactory = new ServiceValidatorFactory(config.getServiceContextConfiguration());
        this.translator = TranslatorFactory.getTranslator(config.getTranslatorConfiguration());

    }

    /**
     * Construct an un-configured InitiatorService with the provided {@link org.extensiblecatalog.ncip.v2.common.ServiceValidatorFactory}.
     */
    ...
    /**
     * Construct an InitiatorService using the {@link org.extensiblecatalog.ncip.v2.common.ServiceValidatorFactory} and {@link Translator} object provided.
     *
     * @param translator the Translator to use
     */
    ...
    /**
     * Se the {@link org.extensiblecatalog.ncip.v2.common.ServiceValidatorFactory} to be used by this InitiatorService.
     * @param serviceContextFactory
     */
    public void setServiceContextFactory(ServiceValidatorFactory serviceContextFactory) {
