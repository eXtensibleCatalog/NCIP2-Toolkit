...
public class RequestedActionTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<RequestedActionType> {

    public RequestedActionTypeJAXBElementSchemeValuePairConverter() {
        super(RequestedActionType.class);
    }
