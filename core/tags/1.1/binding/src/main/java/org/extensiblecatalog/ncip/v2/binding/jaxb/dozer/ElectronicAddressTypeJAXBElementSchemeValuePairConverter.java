...
public class ElectronicAddressTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<ElectronicAddressType> {

    public ElectronicAddressTypeJAXBElementSchemeValuePairConverter() {
        super(ElectronicAddressType.class);
    }
