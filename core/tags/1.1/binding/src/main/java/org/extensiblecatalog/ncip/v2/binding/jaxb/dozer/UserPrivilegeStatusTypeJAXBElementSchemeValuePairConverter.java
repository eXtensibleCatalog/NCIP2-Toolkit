...
public class UserPrivilegeStatusTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<UserPrivilegeStatusType> {

    public UserPrivilegeStatusTypeJAXBElementSchemeValuePairConverter() {
        super(UserPrivilegeStatusType.class);
    }
