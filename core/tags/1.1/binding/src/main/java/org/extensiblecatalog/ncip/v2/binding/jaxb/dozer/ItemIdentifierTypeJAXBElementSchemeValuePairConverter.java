...
public class ItemIdentifierTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<ItemIdentifierType> {

    public ItemIdentifierTypeJAXBElementSchemeValuePairConverter() {
        super(ItemIdentifierType.class);
    }
