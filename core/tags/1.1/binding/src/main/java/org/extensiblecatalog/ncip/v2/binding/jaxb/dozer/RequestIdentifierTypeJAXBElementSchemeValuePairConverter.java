...
public class RequestIdentifierTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<RequestIdentifierType> {

    public RequestIdentifierTypeJAXBElementSchemeValuePairConverter() {
        super(RequestIdentifierType.class);
    }
