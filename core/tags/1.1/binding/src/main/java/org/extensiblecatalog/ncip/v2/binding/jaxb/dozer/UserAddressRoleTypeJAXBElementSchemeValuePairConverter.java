...
public class UserAddressRoleTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<UserAddressRoleType> {

    public UserAddressRoleTypeJAXBElementSchemeValuePairConverter() {
        super(UserAddressRoleType.class);
    }
