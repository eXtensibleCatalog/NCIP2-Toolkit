...
public class AtomicTypeExtensionConverter extends DozerConverter<Object, Ext> implements MapperAware {
    ...
    public AtomicTypeExtensionConverter() {
    ...
    // TODO: These three methods are similar to ones in ContentMappingFactory; try to refactor into helper methods
