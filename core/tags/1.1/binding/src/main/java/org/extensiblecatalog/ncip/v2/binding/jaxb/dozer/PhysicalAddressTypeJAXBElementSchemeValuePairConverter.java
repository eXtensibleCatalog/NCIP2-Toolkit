...
public class PhysicalAddressTypeJAXBElementSchemeValuePairConverter
    extends JAXBElementSchemeValuePairConverter<PhysicalAddressType> {

    public PhysicalAddressTypeJAXBElementSchemeValuePairConverter() {
        super(PhysicalAddressType.class);
    }
