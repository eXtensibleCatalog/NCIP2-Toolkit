...
public class NCIPServlet extends HttpServlet {
    ...
    /**
     * The {@link org.extensiblecatalog.ncip.v2.service.ServiceValidator} instance used to create {@link ServiceContext}s.
     */
     ...
     * {@link ServiceContext} and {@link org.extensiblecatalog.ncip.v2.common.StatisticsBean}.
     *
    ...
    /**
     * Set the {@link org.extensiblecatalog.ncip.v2.common.StatisticsBean} for this responder instance
     *
    ...
    protected void returnException(HttpServletResponse response, String msg, Throwable e) throws ServletException {
        if (includeStackTracesInProblemResponse) {
            String exceptionString = ServiceHelper.convertExceptionToString(e);
            returnProblem(response, msg + System.getProperty("line.separator")
                + "Stacktrace from NCIP responder:" + System.getProperty("line.separator") + exceptionString);
        } else {
