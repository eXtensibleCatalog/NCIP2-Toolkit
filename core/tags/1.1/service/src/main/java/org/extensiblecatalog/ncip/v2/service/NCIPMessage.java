...
public class NCIPMessage {
    ...
    public enum MessageType { INITIATION, RESPONSE };
    ...
    public NCIPInitiationData getInitiationData() throws InvocationTargetException, IllegalAccessException {

        return ReflectionHelper.getInitiationData(this);

    }

    public NCIPResponseData getResponseData() throws InvocationTargetException, IllegalAccessException {

        return ReflectionHelper.getResponseData(this);

    }

    // TODO: In each setter, set messageType;
    ...
    public NCIPData getData() throws InvocationTargetException, IllegalAccessException {
