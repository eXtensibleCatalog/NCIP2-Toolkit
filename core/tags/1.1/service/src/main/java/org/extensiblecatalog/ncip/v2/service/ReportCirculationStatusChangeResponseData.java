...
/**
 * Carries data elements describing the ReportCirculationStatusChangeResponse.
 */
public class ReportCirculationStatusChangeResponseData implements NCIPResponseData {
