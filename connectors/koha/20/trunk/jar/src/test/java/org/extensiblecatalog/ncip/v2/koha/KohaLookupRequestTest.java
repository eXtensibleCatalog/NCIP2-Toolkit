...
public class KohaLookupRequestTest extends TestCase {
	public void testPerformService() throws ServiceException, ParserConfigurationException, SAXException {
		KohaLookupRequestService service = new KohaLookupRequestService();
		...
		String itemIdVal = "KOH01000065021-KOH50000065021000010";
