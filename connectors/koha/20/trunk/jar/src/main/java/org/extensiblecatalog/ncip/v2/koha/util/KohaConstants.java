...
public class KohaConstants {
	...
	/**
	 * X-Server address for making Koha X-Service calls
	 */
	public static final String CONFIG_KOHA_X_SERVER_NAME = "KohaXServerName";

	/**
	 * X-Server port for making Koha X-Service calls
	 */
	public static final String CONFIG_KOHA_X_SERVER_PORT = "KohaXServerPort";

	/**
	 * X-Server address for making Koha RESTful APIs calls
	 */
	public static final String CONFIG_KOHA_API_NAME = "KohaAPIName";

	/**
	 * X-Server port for making Koha RESTful APIs calls
	 */
	public static final String CONFIG_KOHA_API_PORT = "KohaAPIPort";
	 ...
	 */
	public static final String CONFIG_KOHA_AGENCY_COUNT = "KohaAgencyCount";
	...
	public static final String CONFIG_KOHA_CIRC_STATUS_AVAILABLE = "KohaCircStatusAvailable";
	public static final String CONFIG_KOHA_CIRC_STATUS_POSSIBLY_AVAILABLE = "KohaCircStatusPossiblyAvailable";
	public static final String CONFIG_KOHA_CIRC_STATUS_NOT_AVAILABLE = "KohaCircStatusNotAvailable";
	...
	public static final boolean FIRST_SURNAME = true; // Sets whether koha returns first surname at z304-address-2

	public static final SimpleDateFormat KOHA_DATE_FORMATTER = new SimpleDateFormat("yyyyMMdd");
	public static final SimpleDateFormat KOHA_HOUR_FORMATTER = new SimpleDateFormat("HHmm");

	// Both Koha (RESTful APIs & X-Services) nodes:
	...
	// Koha XServices http params & GET request params:
	public static final String KOHAAPI_BOR_AUTH = "bor-auth";
	public static final String KOHAAPI_BOR_INFO = "bor-info";
	public static final String KOHAAPI_CIRC_STATUS = "circ-status";
	public static final String KOHAAPI_ITEM_DATA = "item-data";
	public static final String KOHAAPI_READ_ITEM = "read-item";
	public static final String KOHAAPI_GET_ITEM_LIST = "get-item-list";
	public static final String KOHAAPI_GET_HOLDING = "get-holding";
	public static final String KOHAAPI_HOLD_REQUEST = "hold-req";
	public static final String KOHAAPI_CANCEL_HOLD_REQUEST = "hold-req-cancel";
	public static final String KOHAAPI_RENEW = "renew";
	public static final String KOHAAPI_PUBLISH_AVAILABILITY = "publish_avail";
	public static final String PARAM_KOHAAPI_NAME = "op";
	...
	public static final String XSERVER_NAME = "KohaXServerName";
	public static final String XSERVER_PORT = "KohaXServerPort";
	public static final String XSERVER_SUFFIX = "KohaXServerSuffix";

	public static final String DEFAULT_AGENCY = "DefaultAgency";
	public static final String BIBLIOGRAPHIC_LIBRARY = "KohaBibLibrary";
	public static final String KOHA_ADMINISTRATIVE_LIBRARY = "KohaAdmLibrary";
	...
	// Item statuses of Koha ILS here:
	...
	public static final String KOHA_ILS_AGENCY = "KohaILSAgency";
	public static final String KOHA_HOLD_LIBRARY = "KohaHoldLibrary";
