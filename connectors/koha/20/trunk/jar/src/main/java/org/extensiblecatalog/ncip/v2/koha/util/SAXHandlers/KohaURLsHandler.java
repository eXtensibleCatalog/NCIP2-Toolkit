...
public class KohaURLsHandler extends DefaultHandler {
	...
	/**
	 * KohaURLsHandler is a SAX parser used to parse links from href attributes within &lt;item&gt; node in defined range.<br>
	 * <br>
	 ...
	 */
	public KohaURLsHandler(int fromIndex, int maxLinks) {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		if (qName.equalsIgnoreCase(KohaConstants.ITEMS_NODE)) {
