...
import org.extensiblecatalog.ncip.v2.koha.util.KohaPatronAddress;
 ...
 */
public class KohaUpdateUserHandler extends DefaultHandler {

	private KohaPatronAddress patronAddress;
	...
	public KohaUpdateUserHandler() {
		patronAddress = new KohaPatronAddress();
	}

	@Override
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		if (parsingMandatoryFields) {
			if (qName.equalsIgnoreCase(KohaConstants.ADDRESS_INFORMATION_NODE)) {
				isUpdateable = attributes.getValue(KohaConstants.UPDATEABLE_NODE_ATTRIBUTE).equalsIgnoreCase(KohaConstants.YES);
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_ADDRESS_1_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);

				if (maxLength != null)
					patronAddress.setZ304address1MaxLength(maxLength);

				z304address1Reached = true;
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_DATE_FROM_NODE)) {
				z304dateFromReached = true;
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_DATE_TO_NODE))
				z304dateToReached = true;
		} else {
			if (qName.equalsIgnoreCase(KohaConstants.REPLY_CODE_NODE)) {
				replyCodeReached = true;
			} else if (qName.equalsIgnoreCase(KohaConstants.REPLY_TEXT_NODE)) {
				replyTextReached = true;
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_ADDRESS_2_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_ADDRESS_3_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_ADDRESS_4_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_ADDRESS_5_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_TELEPHONE_1_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_TELEPHONE_2_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_TELEPHONE_3_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_TELEPHONE_4_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
			...
			} else if (qName.equalsIgnoreCase(KohaConstants.Z304_EMAIL_ADDRESS_NODE)) {
				String maxLength = attributes.getValue(KohaConstants.MAX_LEN_NODE_ATTRIBUTE);
	...
	public KohaUpdateUserHandler setParsingMandatoryFields() {
	...
	public KohaPatronAddress getPatronAddress() {
