...
public class KohaRequestItem implements Serializable {
	...
	public void addRequestId(String requestId) {
		if (this.requestId != null) {
			...
			this.requestId.setRequestIdentifierValue(this.requestId.getRequestIdentifierValue() + KohaConstants.REQUEST_ID_DELIMITER + requestId);
		} else {
