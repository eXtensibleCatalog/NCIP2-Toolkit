...
public class VoyagerLookupItemSetService implements LookupItemSetService {
    ...
    private ElectronicResource getElectronicResource(Document doc) throws ILSException {
        ...
        XPath xpath;
        try {
            //xpath = XPath.newInstance("/ser:voyagerServiceData/ser:serviceData/hol:holdingsRecord/hol:bibRecord/hol:marcRecord");
    ...
    private String getCallNumberForHoldingDoc(String holdingId, Document doc) {
        List<Element> items, holdings = null;
